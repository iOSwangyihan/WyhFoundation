//
//  SummaryOfAppleWatchDevelopmentTutorialMaterialsDemoViewController.swift
//  WyhFoundation
//
...
class SummaryOfAppleWatchDevelopmentTutorialMaterialsDemoViewController: SwiftViewController {
    var url = ""
