#
#  Be sure to run `pod spec lint WyhFoundation.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/iOSwangyihan/WyhFoundation.git"
  ...
  spec.source       = { :git => ""https://github.com/iOSwangyihan/WyhFoundation.git", :tag => "#{spec.version}" }
