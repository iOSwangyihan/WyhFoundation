...
import UIKit
enum CoreMediaViewControllerType {
    case overview
    case topics
    case demo
    func name() -> String {
...
class CoreMediaViewController: SwiftViewController {
    
    override func viewDidLoad() {
        super.viewDidLoad()
        dataArr = [CoreMediaViewControllerType.overview, CoreMediaViewControllerType.topics, CoreMediaViewControllerType.demo]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.textLabel?.text = (dataArr[indexPath.row] as? CoreMediaViewControllerType)?.name()
        return cell
    }
  
    override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        
        let type = dataArr[indexPath.row] as? CoreMediaViewControllerType ?? CoreMediaViewControllerType.overview
        if type == .demo {
